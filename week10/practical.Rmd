...
download.file("https://www.encodeproject.org/files/ENCFF776TFX/@@download/ENCFF776TFX.bed.gz", "data/p300.narrowPeak.gz")
# Hi-C long-range interactions in A549 cells:
download.file("https://www.encodeproject.org/files/ENCFF803ZOW/@@download/ENCFF803ZOW.tsv", "data/interactions.tsv")
```

Load the interaction data, and form an GInteractions object:

```{r}
hic <- read.delim("data/interactions.tsv")
head(hic)
...
```{r}
peaks <- rtracklayer::import("data/p300.narrowPeak.gz")
...
```{r}
download.file("https://ethz-ins.org/content/hgEns104.promoters.rds", "data/promoters.rds")
proms <- readRDS("data/promoters.rds")
```
...
a == "ITGB1"
any(a == "ITGB1")
peaks[which(any(peaks$target == "ITGB1"))]
paste(a, collapse = ";")
paste(a, collapse = ";") == "ITGB1"
```
