...
dir.create("data/clustering_practical", showWarnings = FALSE)
download.file("https://ethz-ins.org/content/clustering_practical.zip", "data/clustering_practical.zip")
unzip("data/clustering_practical.zip", exdir = "data/clustering_practical")
list.files()
```
...
```{r}
tracks <- list.files(path="data/clustering_practical", pattern="bw$", full.names=TRUE)
regions <- rtracklayer::import.bed("data/clustering_practical/regions.bed")
```
